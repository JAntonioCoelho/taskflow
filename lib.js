...
const ICON_PATHS = {
    ...
    subtasks:
        '<polyline points="3.5 7 5.5 9 9 5"/><polyline points="3.5 16 5.5 18 9 14"/><path d="M12 7h9"/><path d="M12 17h9"/>',
    ...
    template:
        '<rect x="4" y="3.5" width="16" height="17" rx="2"/><path d="M8 8.5h8"/><path d="M8 12.5h8"/><path d="M8 16.5h4"/>',
    undo: '<path d="M4 9h11a5 5 0 0 1 0 10h-6"/><polyline points="7.5 5.5 4 9 7.5 12.5"/>',
    printer:
        '<path d="M7 9V3.5h10V9"/><rect x="3.5" y="9" width="17" height="7" rx="2"/><path d="M7 14h10v6.5H7z"/>',
    ...
    settings:
        '<circle cx="12" cy="12" r="3"/><path d="M12 2.5v3"/><path d="M12 18.5v3"/><path d="M2.5 12h3"/><path d="M18.5 12h3"/><path d="M5.3 5.3l2.1 2.1"/><path d="M16.6 16.6l2.1 2.1"/><path d="M18.7 5.3l-2.1 2.1"/><path d="M7.4 16.6l-2.1 2.1"/>',
    ...
    download:
        '<path d="M12 3.5v12"/><polyline points="7.5 11 12 15.5 16.5 11"/><path d="M4.5 19.5h15"/>',
    upload: '<path d="M12 20.5v-12"/><polyline points="7.5 13 12 8.5 16.5 13"/><path d="M4.5 4.5h15"/>',
    keyboard:
        '<rect x="2.5" y="6" width="19" height="12" rx="2"/><path d="M6 9.5h.01"/><path d="M9.5 9.5h.01"/><path d="M13 9.5h.01"/><path d="M16.5 9.5h.01"/><path d="M7.5 14h9"/>',
